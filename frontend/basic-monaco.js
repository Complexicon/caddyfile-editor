import * as index from 'monaco-editor/esm/vs/editor/../../external/monaco-lsp-client/out/index.js';
export { index as lsp };
...
import 'monaco-editor/esm/vs/editor/../base/browser/ui/codicons/codicon/codicon.css';
import 'monaco-editor/esm/vs/editor/../base/browser/ui/codicons/codicon/codicon-modifiers.css';
...
export { CancellationTokenSource, Emitter, KeyCode, KeyMod, MarkerSeverity, MarkerTag, Position, Range, Selection, SelectionDirection, Token, Uri, editor, languages } from 'monaco-editor/esm/vs/editor/editor.api2.js';
export { createWebWorker } from 'monaco-editor/esm/vs/editor/../common/workers.js';